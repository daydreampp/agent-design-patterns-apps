...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_GITHUB_USERNAME/agent-design-patterns-apps/main/install.sh | bash
```
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/agent-design-patterns-apps.git
